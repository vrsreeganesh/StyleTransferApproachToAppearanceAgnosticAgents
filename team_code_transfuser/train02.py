...
class Engine(object):
    ...
    def load_data_compute_loss(self, data):
        ...
        statusfilepath = "/projectnb/rlvn/students/vrs/transfuser/team_code_transfuser/mystatus_batchjob.txt"
        ...
        if random.random() < percentageoftimestostyletransfer:
            ...
            content_weight_arg = 1e-10;
            styleweightarg = 1e8;
            # output = NSTSetup(styletensor, rgb/255.0, content_weight_arg, styleweightarg)
            output = NSTSetup(styletensor, rgb/255.0, content_weight_arg=content_weight_arg, style_weightarg=styleweightarg);
            ...
            # if random.random() < 1:
                ...
                torchvision.utils.save_image(gridimage, "/projectnb/rlvn/students/vrs/transfuser/RLVNFinalSubmission/STCarla/whole"+fetchcurrenttime()+".png");
